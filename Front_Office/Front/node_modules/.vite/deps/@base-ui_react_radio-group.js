...
var RadioGroup = React3.forwardRef(function RadioGroup2(componentProps, forwardedRef) {
  const {
    render,
    className,
  ...
  const groupInputRef = React3.useRef(null);
  const firstEnabledInputRef = React3.useRef(null);
  ...
  return (0, import_jsx_runtime2.jsx)(RadioGroupContext.Provider, {
    value: contextValue,
