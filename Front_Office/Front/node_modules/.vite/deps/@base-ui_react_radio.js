...
} from "./chunk-UQGV62KA.js";
import {
  useAriaLabelledBy,
  useFieldItemContext
} from "./chunk-KEKLQLIT.js";
import {
  useLabelableId
...
var RadioRootContext = React2.createContext(void 0);
if (true) RadioRootContext.displayName = "RadioRootContext";
function useRadioRootContext() {
  const value = React2.useContext(RadioRootContext);
  if (value === void 0) {
...
var RadioRoot = React3.forwardRef(function RadioRoot2(componentProps, forwardedRef) {
  const {
    render,
    className,
  ...
  const radioRef = React3.useRef(null);
  ...
  return (0, import_jsx_runtime.jsxs)(RadioRootContext.Provider, {
    value: contextValue,
    children: [isRadioGroup ? (0, import_jsx_runtime.jsx)(CompositeItem, {
      tag: "span",
      render,
      className,
      style,
      ...
      props,
      stateAttributesMapping
    }) : element, (0, import_jsx_runtime.jsx)("input", {
      ...inputProps,
...
var RadioIndicator = React4.forwardRef(function RadioIndicator2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
