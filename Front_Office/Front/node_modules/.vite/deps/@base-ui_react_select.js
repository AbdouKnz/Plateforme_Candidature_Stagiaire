...
} from "./chunk-DQB4TONZ.js";
import {
  visuallyHidden,
  visuallyHiddenInput
} from "./chunk-6YMZKEUK.js";
import {
  COMPOSITE_KEYS,
  CompositeList,
  isElementDisabled,
  useDirection
} from "./chunk-2VUVLHXD.js";
import {
  useValueChanged
} from "./chunk-2P3WXH66.js";
import "./chunk-4M35GBWR.js";
import {
  Separator
} from "./chunk-DMJ3WTVH.js";
import {
  useButton
} from "./chunk-Q4GZJQ26.js";
import "./chunk-UQGV62KA.js";
import {
  Timeout,
  useLabel,
  useTimeout
} from "./chunk-JB2MVGXE.js";
import {
  useLabelableId
} from "./chunk-H546FD46.js";
import {
  AnimationFrame,
...
import {
  ...
  stopEvent,
  tabbable
} from "./chunk-P7CCDJ43.js";
import {
  useControlled,
  useFormContext,
  useRegisterFieldControl
} from "./chunk-5P2URFVR.js";
import {
...
import {
  ...
  useRefWithInit,
  useRenderElement
} from "./chunk-EOWU4R7W.js";
import {
  mergeProps
} from "./chunk-BA5YDPBM.js";
import {
  require_react
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React58 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState15 = React58.useState, useEffect12 = React58.useEffect, useLayoutEffect2 = React58.useLayoutEffect, useDebugValue2 = React58.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React58 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef27 = React58.useRef, useEffect12 = React58.useEffect, useMemo20 = React58.useMemo, useDebugValue2 = React58.useDebugValue;
...
var SelectRootContext = React26.createContext(null);
if (true) SelectRootContext.displayName = "SelectRootContext";
var SelectFloatingContext = React26.createContext(null);
if (true) SelectFloatingContext.displayName = "SelectFloatingContext";
function useSelectRootContext() {
  const context = React26.useContext(SelectRootContext);
  if (context === null) {
...
function useSelectFloatingContext() {
  const context = React26.useContext(SelectFloatingContext);
  if (context === null) {
...
function resolveMultipleLabels(values, items, itemToStringLabel) {
  return values.reduce((acc, value, index2) => {
    ...
    acc.push((0, import_jsx_runtime7.jsx)(React27.Fragment, {
...
function SelectRoot(props) {
  ...
  const firstItemTextRef = React30.useRef(null);
  ...
  const popupProps = React30.useMemo(() => mergeProps(FOCUSABLE_POPUP_PROPS, typeahead.floating, listNavigation.floating, dismiss.floating), [typeahead.floating, listNavigation.floating, dismiss.floating]);
...
var SelectPositioner = React42.forwardRef(function SelectPositioner2(componentProps, forwardedRef) {
  const {
    anchor,
    positionMethod = "absolute",
    className,
  ...
  const transitionStatus = useStore(store, selectors2.transitionStatus);
  const scrollUpArrowRef = React42.useRef(null);
  const scrollDownArrowRef = React42.useRef(null);
  const [controlledAlignItemWithTrigger, setControlledAlignItemWithTrigger] = React42.useState(alignItemWithTrigger);
  ...
  React42.useImperativeHandle(alignItemWithTriggerActiveRef, () => alignItemWithTriggerActive);
  ...
  const prevMapSizeRef = React42.useRef(0);
...
var ToolbarRootContext = React43.createContext(void 0);
...
var CSPContext = React44.createContext(void 0);
if (true) CSPContext.displayName = "CSPContext";
var DEFAULT_CSP_CONTEXT_VALUE = {
  disableStyleElements: false
};
function useCSPContext() {
  return React44.useContext(CSPContext) ?? DEFAULT_CSP_CONTEXT_VALUE;
}
...
var SelectPopup = React45.forwardRef(function SelectPopup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const positionerElement = useStore(store, selectors2.positionerElement);
  const listElement = useStore(store, selectors2.listElement);
  const reachedMaxHeightRef = React45.useRef(false);
  const initialPlacedRef = React45.useRef(false);
  const originalPositionerStylesRef = React45.useRef({});
  ...
  React45.useImperativeHandle(scrollHandlerRef, () => handleScroll, [handleScroll]);
  useOpenChangeComplete({
    open,
    ref: popupRef,
    onComplete() {
  ...
  return (0, import_jsx_runtime13.jsxs)(React45.Fragment, {
...
var SelectList = React46.forwardRef(function SelectList2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var SelectItemContext = React47.createContext(void 0);
if (true) SelectItemContext.displayName = "SelectItemContext";
function useSelectItemContext() {
  const context = React47.useContext(SelectItemContext);
  if (!context) {
...
var SelectItem = React48.memo(React48.forwardRef(function SelectItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const lastKeyRef = React48.useRef(null);
  const pointerTypeRef = React48.useRef("mouse");
  const allowMouseSelectionRef = React48.useRef(false);
  const {
    getButtonProps,
    buttonRef
  } = useButton({
...
var SelectItemIndicator = React49.forwardRef(function SelectItemIndicator2(componentProps, forwardedRef) {
...
var Inner = React49.memo(React49.forwardRef((componentProps, forwardedRef) => {
  const {
    render,
    className,
    style,
...
var SelectItemText = React50.memo(React50.forwardRef(function SelectItemText2(componentProps, forwardedRef) {
  const {
    index: index2,
    textRef,
    selectedByFocus,
  ...
  const localRef = React50.useCallback((node) => {
    if (!node) {
      return;
    }
...
var SelectArrow = React51.forwardRef(function SelectArrow2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var SelectScrollArrow = React52.forwardRef(function SelectScrollArrow2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var SelectScrollDownArrow = React53.forwardRef(function SelectScrollDownArrow2(props, forwardedRef) {
...
var SelectScrollUpArrow = React54.forwardRef(function SelectScrollUpArrow2(props, forwardedRef) {
...
var SelectGroupContext = React55.createContext(void 0);
if (true) SelectGroupContext.displayName = "SelectGroupContext";
function useSelectGroupContext() {
  const context = React55.useContext(SelectGroupContext);
  if (context === void 0) {
...
var SelectGroup = React56.forwardRef(function SelectGroup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const [labelId, setLabelId] = React56.useState();
...
var SelectGroupLabel = React57.forwardRef(function SelectGroupLabel2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
